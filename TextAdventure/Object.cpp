...
int Object::createUniqueID(std::string p_object_name, double p_weight, double p_width, double p_height, double p_length)
{
	int id = 0;
...
Object::Object(std::string p_name, double p_weight, double p_width, double p_height, double p_length, int p_uniqueID)
{
